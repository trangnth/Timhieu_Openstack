...
Cần cấu hình management interface như sau:

> IP address: 192.168.68.71<br>
> Network mask: 255.255.255.0 (or /24)<br>
...
Configure the Linux bridge agent, edit file `/etc/neutron/plugins/ml2/linuxbridge_agent.ini`:
