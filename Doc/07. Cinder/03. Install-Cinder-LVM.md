...
* Cấu hình kết nối tới database 
		...
		[database]
		connection = mysql+pymysql://cinder:trang1234@192.168.40.74/cinder 
...
* Configure Identity service access
	...
	[keystone_authtoken]
	www_authenticate_uri = http://192.168.40.74:5000
	auth_url = http://192.168.40.74:5000
	memcached_servers = 192.168.40.74:11211
	auth_type = password
	project_domain_id = default
	user_domain_id = default
	project_name = service
...
Như trên là vẫn chưa được, tiến hành kiểm tra lại các bước cấu hình
